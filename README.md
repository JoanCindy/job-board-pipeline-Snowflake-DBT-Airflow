...
Pipeline de données permettant de centraliser les offres d'emploi d'un job board dans un data warehouse Snowflake, de les transformer via dbt selon une modélisation en étoile, puis d'automatiser l'ensemble avec Airflow.
...
- **Orchestration (Airflow)** : automatisation de l'extraction et des runs dbt.
